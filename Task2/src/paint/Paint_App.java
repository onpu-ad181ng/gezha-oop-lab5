        ...
        if (ptemp instanceof MyRectangle) {
          ...
          if (rhombus.contains(startDrag)) {
            ...
            if (rhombus.getColor() == null) {
              g2.getGraphicAdapter().setColor(rhombus.getLineColor());
              g2.getGraphicAdapter().drawPolygon(newXs, newYs, 4);
            } else {
              g2.getGraphicAdapter().setColor(rhombus.getColor());
              g2.getGraphicAdapter().fillPolygon(newXs, newYs, 4);
              g2.getGraphicAdapter().drawPolygon(newXs, newYs, 4);
            }
          }
